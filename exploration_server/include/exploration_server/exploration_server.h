...
namespace exploration_server {
    ...
    private:
        ...
        /**
         * @brief Function to check and see if the robot is in the polygon boundary and send a
         * move_base command for the robot to move back to the center point in the boundary if the
         * robot is outside it
        ...
        /**
         * @brief Callback for initially starting off the exploration, starts up the planner plugin
         * and requests first movement goal for the robot then sends that goal to move_base.
         * @param gh GoalHandle which includes reference to the goal which has the name of the
         * planner plugin and the inital boundary polygon
         */
        ...
        /**
         * @brief Method to request the next goal from the planner plugin and send it to the
         * move_base client
         */
