...
namespace polygon_layer {
    ...
    public:
        ...
        /**
         * @brief Calculate bounds of costmap window to update and draw the polygon onto the local
         * costmap
         */
    ...
    private:
         ...
         */
        bool
        setPolygonCb(exploration_msgs::SetPolygon::Request& req,   // NOLINT (runtime/references)
        ...
        void reconfigureCb(costmap_2d::GenericPluginConfig& config,
                           uint32_t level); // NOLINT (runtime/references)
