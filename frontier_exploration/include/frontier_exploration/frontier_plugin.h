...
namespace frontier_exploration {
    ...
    public:
        ...
        virtual void initialize(
            boost::shared_ptr<costmap_2d::Costmap2DROS>& costmap); // NOLINT (runtime/references)

        /**
         * @brief Future define for visualization_msgs::Marker::DELETEALL. Constant is not defined
         * in ROS Indigo, but functionality is implemented
         */
         ...
         */
        virtual void addToVisited(geometry_msgs::Point previous_goal,
         ...
         * @param previous_goal the point that was previously sent to move base by the plugin or the
         * server (if robot outside of the exploration boundary)
         * @return list of possible points to explore next
         */
        virtual std::vector<geometry_msgs::Point>
        whereToExplore(const geometry_msgs::PoseStamped& start_pose,
